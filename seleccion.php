    ...
    <div class="container-login">
        ...
        <div class="o-form-container">
            ...
            <form action="nodo.php" method="POST">
                Led: <input type="text" name="nodo" class="o-input"><br>
                Dato: <br>
                <input type="submit" name="variable" class="o-button" value="Seguro">
                <input type="submit" name="variable" value="Usuario" class="o-button">
            </form>
